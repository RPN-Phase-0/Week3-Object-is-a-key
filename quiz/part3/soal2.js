/*
Diberikan sebuah function shoppingTime(memberId, money) yang menerima dua parameter berupa string 
dan number. Parameter pertama merupakan memberId dan parameter ke-2 merupakan value uang yang dibawa 
...
Member yang berbelanja di toko X akan membeli barang yang paling mahal terlebih dahulu dan akan 
...
function shoppingTime(memberId, money) {
    ...
    for(let data of barang) {
      if(changeMoney >= data.price) {
        listPurchased.push(data.name);
        changeMoney = changeMoney - data.price;
      }
    }
    return {
      memberId: memberId,
