...
function shoppingTime(memberId, money) {
    ...
    if(memberId == '' || memberId == undefined) return "Mohon maaf, toko X hanya berlaku untuk member saja";
        ...
        let listPurchased = [], tempMoney = money;
        let listBarang = [["Sepatu Stacattu", 1500000], ["Baju Zoro", 500000], ["Baju H&N", 250000], ["Sweater Uniklooh", 175000],
                            ["Casing Handphone", 50000]];
        for(let i = 0; i < listBarang.length; i++){
            if(listBarang[i][1] <= money){
